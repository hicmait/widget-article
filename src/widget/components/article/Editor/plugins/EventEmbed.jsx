...
import { getEventUrl, getDateLabel } from "../../../../services/utils";

const addEvent = async (eventId, ttpApiUrl, token) => {
...
const EventEmbed = {
  ...
  onClick: async function () {
    ...
    try {
      const response = await addEvent(eventId, ttpApiUrl, token);
